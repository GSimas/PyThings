...
if __name__ == "__main__":
    ...
    src_file = input("File Name to Read: ")
    if ".txt" not in src_file:
        src_file = src_file + ".txt"
    src_file_fd = open(src_file, 'r')
    text = src_file_fd.read()
    src_file_fd.close()

    file_name = input("File Name to Write: ")

    vhdl_path = os.path.splitext(src_file_path)[0] + "\\" + file_name + '.vhd'
    ...
    print('VHDL file created in the folder with sucess')
